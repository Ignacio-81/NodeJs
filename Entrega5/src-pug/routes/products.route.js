...
router.get("/products", (req, res) => {
    if ((products.length == 0) || (products == "[]")){
        res.render("products.pug", { products : products, hasAny: false })
    }
    //res.render("products.pug", { products, hasAny: true })
    res.render("products.pug", { products : products, hasAny: true })
})
